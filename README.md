...
**🆕 新手用户**：建议阅读 → [💡 小白用户指南](#-小白用户指南推荐) | [💡 安装版常见问题](#-安装版用户常见问题)

**👨‍💻 开发者**：建议阅读 → [👨‍💻 开发者指南](#-开发者指南) | [🛠️ 项目结构](#️-项目结构)

**📖 查看功能**：[✨ 特性](#-特性) | [📖 使用指南](#-使用指南) | [❓ 常见问题](#-常见问题)
...
如果您是普通用户，不熟悉 Python 开发，请按照以下步骤操作：

#### 第 1 步：下载并安装程序

1. 前往 [Releases](../../releases) 页面
2. 下载最新版本的 `Shinobu-Voice-Transcriber-Setup-vX.X.X.exe` 安装包
3. 双击运行安装程序，按照向导完成安装
4. 安装完成后，从开始菜单或桌面启动程序
...
1. 点击程序界面左侧的 ⚙️ **设置** 图标
2. 在设置页面找到"**下载依赖**"部分
3. 在 **FFmpeg** 卡片上点击"**下载**"按钮
4. 等待下载完成（约 100MB，通常 1-5 分钟）
5. 看到"**已安装**"提示即表示成功

**② 下载 Whisper-Faster-XXL（语音识别引擎）**
1. 在同一个"下载依赖"部分
2. 在 **Whisper-Faster-XXL** 卡片上点击"**下载**"按钮
3. 等待下载完成（约 2GB，通常 10-30 分钟）
   - 💡 提示：下载时会显示动画进度条
   - ⚠️ 注意：请保持网络连接稳定
4. 看到"**已安装**"提示即表示成功
...
1. 点击左侧的 🎙️ **听写** 图标
2. 点击"**选择**"按钮，选择要转录的音频或视频文件
3. 配置基本参数：
   - **Whisper 模型**：选择 `whisper-faster.exe`（刚才下载的）
   - **输入语言**：选择音频的语言（如"中文"）
   - **输出格式**：选择需要的格式（推荐"原文 SRT"）
4. 点击"**听写**"按钮开始转录
5. 转录完成后，文件会保存在原文件相同的目录

#### 💡 使用提示

- ✅ **首次使用**：建议先用较短的音频测试（3-5 分钟）
- ✅ **网络问题**：如果自动下载失败，可以查看"常见问题"部分
- ✅ **查看进度**：点击左侧的 📋 **任务** 图标可查看转录日志
- ✅ **主题切换**：在设置中可以切换亮色/暗色主题

---

### 👨‍💻 开发者指南

如果您是开发者，想要从源代码运行或参与开发，请继续阅读：
...
2. 下载最新版本的 `.exe` 安装包
3. 如果没有发布版本，可以联系开发者或等待后续发布

#### Q: 安装后找不到程序？

**A**: 
1. 检查开始菜单中的"Shinobu Voice Transcriber"
2. 查看桌面是否有快捷方式
3. 默认安装路径：`C:\Program Files\Shinobu-Voice-Transcriber\`

#### Q: 首次运行需要做什么？

**A**: 
1. 首次运行后，必须先下载两个组件（FFmpeg 和 Whisper-Faster-XXL）
2. 打开设置界面，在"下载依赖"部分分别点击下载
3. 等待两个组件都显示"已安装"后即可正常使用
4. 详细步骤请参考上方的"小白用户指南"
